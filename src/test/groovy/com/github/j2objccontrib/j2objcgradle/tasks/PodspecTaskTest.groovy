...
class PodspecTaskTest {
    ...
    void testPodspecWrite() {
        ...
        assert expectedPodNameDebug == j2objcPodspec.getBasePodName()
        assert expectedPodNameRelease == j2objcPodspec.getBasePodName()
    ...
    @Test
    void testGenPodspec() {
        double swiftVersion = 3.1
        List<String> podspecDebug = PodspecTask.genPodspec(
            swiftVersion, 'POD-NAME', '$(PODS_ROOT)/POD-NAME/HEADER_INCLUDE', 'MAIN-RESOURCES', 'PROJECT-DIR',
            'LIB-DIR-IOS', 'MIN-VERSION-IOS', 'LIB-NAME', '$(PODS_ROOT)/POD-NAME/j2objc', 'AUTHOR',
            'LICENCE', 'HOMEPAGE_URL', 'SOURCE_URL', 'VERSION',
            true, false).split('\n')
        ...
        List<String> expectedPodspecDebug = [
                ...
                "    s.resources = 'MAIN-RESOURCES/**/*'",
                "    s.requires_arc = true",
                "    s.libraries = 'ObjC', 'guava', 'javax_inject', 'jre_emul', 'jsr305', 'z', 'icucore'",
                "    s.ios.vendored_libraries = 'LIB-DIR-IOS/libLIB-NAME.a'",
//                "    s.osx.vendored_libraries = 'LIB-DIR-OSX/libLIB-NAME.a'",
//                "    s.watchos.vendored_libraries = 'LIB-DIR-WATCHOS/libLIB-NAME.a'",
                "    s.xcconfig = {",
...
//                "      'LIBRARY_SEARCH_PATHS' => '/J2OBJC_HOME/lib'",
//                "    }",
                "    s.ios.deployment_target = 'MIN-VERSION-IOS'",
//                "    s.osx.deployment_target = '10.8.1'",
